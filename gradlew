...
#
#   (2) In order to add or change JVM options, please change the following line:
#
...
Please set the JAVA_HOME variable in your environment (or add java to PATH) to match the
location of your Java installation."
    fi
fi
